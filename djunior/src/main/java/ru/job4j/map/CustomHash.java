...
public class CustomHash<K,V> {
    ...
    public HashEntry get(K key) {
        ...
        System.out.println(table[hash].hashCode()+" "+key.hashCode());
        //HashEntry entry = table[hash] != null && (table[hash].hashCode() == key.hashCode() && table[hash].getKey().equals(key)) ? table[hash] : null;
